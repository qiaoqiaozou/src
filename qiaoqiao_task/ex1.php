...
<head>
    ...
    <title>DocumentExercise 1: Getting Started with PHP - Qiaoqiao</title>
</head>
<body>
    ...
    <h3>3.2 Create a PHP variable named $title and assign it the value "PHP is interesting." Then, use this variable as the content within an <h4> (heading 4) element.
    </h3>
    <?php
